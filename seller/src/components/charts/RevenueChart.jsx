  ...
  return (
    <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
      <div className="mb-6 flex justify-between items-center">
        <div>
            <h3 className="text-lg font-bold text-gray-800">Revenue vs Profit</h3>
            <p className="text-sm text-gray-500">Weekly financial comparison</p>
        </div>
      ...
      <div className="w-full h-[300px]">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            ...
            <Bar dataKey="revenue" fill="#10B981" radius={[4, 4, 0, 0]} barSize={30} name="Total Revenue" />
            <Bar dataKey="profit" fill="#3B82F6" radius={[4, 4, 0, 0]} barSize={30} name="Net Profit" />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
